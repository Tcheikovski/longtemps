import { AnyObject, EmptyObject, Override, UnknownObject } from '@longtemps/core'
...
export namespace Api {
  ...
  export type Document<T extends AnyObject = UnknownObject, U extends AnyObject = EmptyObject> = Override<T, U & { _links: Document.Links }>
